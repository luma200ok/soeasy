...
export function CityCard({ city }: CityCardProps) {
  return (
    <Link href={`/cities/${city.id}`} className="block group">
      <Card className="relative overflow-hidden cursor-pointer transition-all duration-200 hover:shadow-lg hover:-translate-y-1 p-0">
